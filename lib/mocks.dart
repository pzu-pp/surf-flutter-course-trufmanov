...
final List<Sight> mocks = [
  ...
  Sight(
    ...
    lat: 47.512928,
    lon: 42.183677,
    url: 'https://tur-ray.ru/wp-content/uploads/2020/01/kurgan-kazachey-slavy.jpg',
    details: 'Красивый памятный объект этот был открыт у берегов Сухо-Соленовской балки немногим более 10 лет назад – в 2008 г. Его авторами выступили писатель В. Карпенко и скульптор Е. Дердиященко. Мемориальная композиция эта являет собой собрание нескольких памятников, в том числе Бакланову, о котором мы расскажем отдельно ниже, и собственно насыпной курган, возвышающийся на 10 м и как бы разбитый на две части.',
    type: 'Памятники',
  ),
