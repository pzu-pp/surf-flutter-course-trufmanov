...
class SightDetailBottomSheet extends StatefulWidget {
  final Sight sight;

  /// Конструктор
  /// sight - класс достопримечательности, обязательный не null параметр
  SightDetailBottomSheet({Key key, @required this.sight})
      : assert(sight != null),
        super(key: key);

  @override
  _SightDetailBottomSheetState createState() => _SightDetailBottomSheetState();
}

class _SightDetailBottomSheetState extends State<SightDetailBottomSheet> {
  int _currentPage = 0;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: () =>
                                print('"ПОСТРОИТЬ МАРШРУТ" pressed'),
                          ),
                        ),
                        Row(
